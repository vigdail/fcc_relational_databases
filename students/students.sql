...
--
-- Name: courses_cource_id_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--

CREATE SEQUENCE public.courses_cource_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.courses_cource_id_seq OWNER TO freecodecamp;

--
-- Name: courses_cource_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.courses_cource_id_seq OWNED BY public.courses.course_id;
...
ALTER TABLE ONLY public.courses ALTER COLUMN course_id SET DEFAULT nextval('public.courses_cource_id_seq'::regclass);
...
--
-- Name: courses_cource_id_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.courses_cource_id_seq', 39, true);
